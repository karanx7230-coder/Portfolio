...
const stats = [
  ...
  { value: "03", label: "Contributed builds", sub: "Features • Releases • UI" },
  { value: "10+", label: "Core technologies", sub: "Supabase • Firebase • Git" },
];
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 border-y border-[#1D1D1F]/10">
          {stats.map((stat, idx) => (
            <motion.div
              ...
              className="px-4 py-8 sm:py-10 text-center border-[#1D1D1F]/10 border-l first:border-l-0 max-lg:[&:nth-child(3)]:border-l-0 max-lg:[&:nth-child(n+3)]:border-t"
            >
